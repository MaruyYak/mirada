...
export function generateFormHtml() {
  ...
  leftAreaImg.src = "./components/main-page/assets/sertificat.png";
  ...
  nominalArrow.src = "./components/main-page/assets/chevron.png";
  ...
  sContactsArrow.src = "./components/main-page/assets/chevron.png";
...
//Recipient input name  information
  ...
  rContactsArrow.src = "./components/main-page/assets/chevron.png";
